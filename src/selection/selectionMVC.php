        ...
        <div class="col-12">
            <div class="d-flex justify-content-between" style="backgournd-color:">
                ...
                <div class="d-flex justify-content-end" >
                    <a href="index.php?uc=brevo"
                        class=" "
                        data-bs-toggle="tooltip" data-bs-placement="bottom" title="Créer une liste Brevo"
                        role="button"> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-mailbox-flag me-2" viewBox="0 0 16 16">
